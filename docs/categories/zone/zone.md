...
| graveyard\_id | float | [Graveyard Identifier](../graveyards/graveyard.md) |
| min\_level | tinyint | Minimum Level |
| min\_status | tinyint | [Minimum Status](https://eqemu.gitbook.io/server/categories/reference-lists/status-levels) |
...
| ruleset | int | [Ruleset Identifier](../rules/rule_sets.md) |
| note | varchar | Note |
