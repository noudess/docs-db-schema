...
| loottable\_id | int | [Loottable Identifier](../loot/loottable.md) |
| merchant\_id | int | [Merchant Identifier](../merchants/merchantlist.md) |
| alt\_currency\_id | int | [Alternate Currency Identifier](../alternate-currency/alternate_currency.md) |
...
| npc\_faction\_id | int | [NPC Faction Identifier](../factions/faction_list.md) |
| adventure\_template\_id | int | [Adventure Template Identifier](../adventures/adventure_template.md) |
| trap\_template | int | [Trap Template Identifier](../traps/traps.md) |
...
| ranged\_type | tinyint | [Ranged Type](https://eqemu.gitbook.io/server/categories/reference-lists/skills) |
...
| stuck\_behavior | tinyint | [Stuck Behavior](https://app.gitbook.com/@eqemu/s/server/categories/reference-lists/stuck-behavior) |
